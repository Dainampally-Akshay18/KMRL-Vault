// RiskAnalysis.jsx - Dark UI Theme with Colored Risk Backgrounds & Dark Glass Charts
...
// ✨ Risk Colors for backgrounds and charts
const RISK_COLORS = {
...
const RiskAnalysis = ({ documentInfo }) => {
  ...
  // Enhanced risk color system with glass backgrounds
  const getRiskColor = (severity) => {
    switch (severity?.toLowerCase()) {
      case 'high':
        return {
          glassBg: 'bg-red-500/20 backdrop-blur-sm',
      ...
      case 'medium':
        return {
          glassBg: 'bg-orange-500/20 backdrop-blur-sm',
      ...
      case 'low':
        return {
          glassBg: 'bg-green-500/20 backdrop-blur-sm',
      ...
      default:
        return {
          glassBg: 'bg-slate-500/20 backdrop-blur-sm',
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
        {/* Risk-themed Animated Orbs for dark theme */}
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-red-500/30 to-orange-500/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-32 right-10 w-80 h-80 bg-gradient-to-r from-[#20B2AA]/20 to-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-r from-orange-400/20 to-red-500/20 rounded-full blur-3xl animate-pulse delay-2000"></div>
        
        {/* Dark theme geometric patterns */}
        <div className="absolute top-10 right-20 w-32 h-32 border border-red-500/20 rounded-3xl rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-20 left-20 w-24 h-24 border border-orange-400/20 rounded-full animate-pulse"></div>
      </div>

      {/* Main Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        
        {/* Simplified Header - Dark Theme */}
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl flex items-center justify-center">
              <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none">
                <path d="M12 9V13M12 17H12.01M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3C7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </div>
            <div>
        ...
        {analysis && (
          <div className="space-y-8">
            {/* Simple Risk Overview Dashboard */}
            ...
            {/* Colored Glass Risk Details - Red/Orange/Green Backgrounds */}
              ...
              <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none">
                      <path d="M9 12L11 14L15 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3C7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" strokeWidth="2"/>
                    </svg>
                  </div>
