...
// ✨ ATTRACTIVE COLOR PALETTES (PRESERVED)
const RISK_COLORS = {
...
// 🎨 Custom Tooltip Component (Updated for new theme)
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white border border-[#81D8D0]/30 rounded-lg p-4 shadow-2xl">
        ...
        {payload.map((entry, index) => (
          <div key={index} className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-600">
              {entry.name}: <span className="text-gray-800 font-bold">{entry.value}</span>
            </span>
          </div>
        ))}
      </div>
...
// Expandable Text Component (Updated theme)
  ...
  return (
    <div>
      ...
      <button
        ...
        className="mt-2 text-red-500 hover:text-red-600 font-medium text-sm underline transition-colors"
      >
      ...
      <div className="p-6">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-[#81D8D0]/30 rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <button 
              onClick={runAnalysis}
              disabled={loading}
              className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-500/50 disabled:hover:transform-none disabled:hover:shadow-none disabled:cursor-not-allowed"
            >
            ...
            {analysis && (
              <button
                ...
                className="bg-[#CCFFEB]/50 hover:bg-[#81D8D0]/20 border border-[#81D8D0]/50 text-gray-700 hover:text-gray-800 font-semibold py-3 px-6 rounded-xl transition-all duration-300"
              >
                {showCharts ? (
        ...
        {loading && (
          <div className="bg-white/60 backdrop-blur-sm border border-[#81D8D0]/30 rounded-2xl p-8">
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">Analyzing Document Risks</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  color: 'from-[#20B2AA] to-[#81D8D0]'
                }
              ].map((metric, index) => (
                <div key={index} className="bg-white/60 backdrop-blur-sm border border-[#81D8D0]/30 rounded-2xl p-6 text-center hover:border-[#20B2AA]/50 transition-all duration-300 hover:-translate-y-1">
            ...
            {showCharts && analysis.analysis?.risks && (
              <div className="bg-white/60 backdrop-blur-sm border border-[#81D8D0]/30 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">Interactive Risk Analytics</h3>
                </div>

                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                  {/* 📊 CHART 1: PIE CHART - Risk Distribution */}
                  <div className="bg-[#CCFFEB]/50 rounded-2xl p-6 border border-[#81D8D0]/30">
                      ...
                      >
                        ...
                        <defs>
                          <linearGradient id="colorGradient1" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#20B2AA" stopOpacity={0.9}/>
                            <stop offset="95%" stopColor="#81D8D0" stopOpacity={0.9}/>
                          </linearGradient>
                        </defs>
                      </BarChart>
                    </ResponsiveContainer>
                  ...
                  <div className="bg-[#CCFFEB]/50 rounded-2xl p-6 border border-[#81D8D0]/30">
                    <h4 className="text-lg font-bold text-gray-800 mb-6 flex items-center gap-2">
                      <span className="w-3 h-3 bg-[#EBA536] rounded-full"></span>
                      ...
                      >
                        ...
                        <defs>
                          <linearGradient id="colorGradient2" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#EBA536" stopOpacity={0.9}/>
                            <stop offset="95%" stopColor="#EAD2AC" stopOpacity={0.9}/>
                          </linearGradient>
                        </defs>
                      </BarChart>
                    </ResponsiveContainer>
                  ...
                  <div className="bg-[#CCFFEB]/50 rounded-2xl p-6 border border-[#81D8D0]/30">
                    <h4 className="text-lg font-bold text-gray-800 mb-6 flex items-center gap-2">
                      <span className="w-3 h-3 bg-[#81D8D0] rounded-full"></span>
                      ...
                      >
                        ...
                        <defs>
                          <linearGradient id="colorGradient3" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#81D8D0" stopOpacity={0.8}/>
                            <stop offset="95%" stopColor="#20B2AA" stopOpacity={0.3}/>
                          </linearGradient>
                        </defs>
                      </AreaChart>
                    </ResponsiveContainer>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800">Identified Risks (Ranked by Priority)</h3>
                  </div>
                  <span className="text-gray-600 text-sm">Highest risks displayed first</span>
                </div>
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                          <div className="flex-1">
                            ...
                            <div className="bg-white/60 border border-[#81D8D0]/30 rounded-xl p-4 mb-4">
        ...
        {!loading && !analysis && !error && (
          <div className="bg-white/60 backdrop-blur-sm border-2 border-dashed border-[#81D8D0]/50 rounded-2xl p-12 text-center">
            ...
            <h4 className="text-xl font-bold text-gray-700 mb-2">Ready to Analyze Risks</h4>
            <p className="text-gray-600">Click "Analyze Document Risks" to identify potential legal risks with beautiful interactive charts and detailed analysis.</p>
          </div>
        )}
      </div>
    </div>
